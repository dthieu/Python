...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(10, 10, 801, 42))
        font = QtGui.QFont()
        ...
        self.frame.setGeometry(QtCore.QRect(10, 70, 801, 581))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(270, 90, 201, 251))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
...
"color: white")
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.btnTargetOff)
...
"color: white")
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.btnTargetRestart)
        self.btnBatOn = QtWidgets.QPushButton(self.groupBox_2)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.btnBatOn.setFont(font)
        self.btnBatOn.setStyleSheet("background-color: rgb(85, 255, 127);")
        self.btnBatOn.setObjectName("btnBatOn")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.btnBatOn)
        self.btnBatOff = QtWidgets.QPushButton(self.groupBox_2)
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        self.btnBatOff.setFont(font)
        self.btnBatOff.setStyleSheet("background-color: #A3C1DA")
        self.btnBatOff.setObjectName("btnBatOff")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.btnBatOff)
        self.btnACCOn = QtWidgets.QPushButton(self.groupBox_2)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.btnACCOn.setFont(font)
        self.btnACCOn.setStyleSheet("background-color: rgb(85, 255, 127);")
        self.btnACCOn.setObjectName("btnACCOn")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.btnACCOn)
        self.btnIGNOff = QtWidgets.QPushButton(self.groupBox_2)
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        self.btnIGNOff.setFont(font)
        self.btnIGNOff.setStyleSheet("background-color: #A3C1DA")
        self.btnIGNOff.setObjectName("btnIGNOff")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.btnIGNOff)
        self.btnACCOff = QtWidgets.QPushButton(self.groupBox_2)
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        self.btnACCOff.setFont(font)
        self.btnACCOff.setStyleSheet("background-color: #A3C1DA")
        self.btnACCOff.setObjectName("btnACCOff")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.btnACCOff)
        self.btnIGNOn = QtWidgets.QPushButton(self.groupBox_2)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.btnIGNOn.setFont(font)
        self.btnIGNOn.setStyleSheet("background-color: rgb(85, 255, 127);")
        self.btnIGNOn.setObjectName("btnIGNOn")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.btnIGNOn)
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.btnACC_IGN_on)
        self.groupBox_3 = QtWidgets.QGroupBox(self.frame)
        self.groupBox_3.setGeometry(QtCore.QRect(10, 173, 251, 171))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.layoutWidget_4.setGeometry(QtCore.QRect(60, 20, 51, 54))
        ...
        self.layoutWidget_5.setGeometry(QtCore.QRect(120, 20, 51, 54))
        ...
        self.layoutWidget_7.setGeometry(QtCore.QRect(190, 20, 51, 54))
        ...
        self.layoutWidget_8.setGeometry(QtCore.QRect(190, 100, 51, 54))
        ...
        self.layoutWidget_6.setGeometry(QtCore.QRect(120, 100, 51, 54))
        ...
        self.layoutWidget_9.setGeometry(QtCore.QRect(60, 100, 51, 54))
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(10, 100, 41, 54))
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(10, 20, 41, 54))
        ...
        self.groupBox_4.setGeometry(QtCore.QRect(480, 10, 321, 331))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.lcdBinState.setGeometry(QtCore.QRect(270, 20, 201, 40))
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setPointSize(10)
        font.setBold(True)
...
"color: blue")
        ...
        self.layoutWidget2.setGeometry(QtCore.QRect(10, 351, 791, 221))
        ...
        self.txtLog = QtWidgets.QPlainTextEdit(self.layoutWidget2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnBatOn.setText(_translate("MainWindow", "BAT ON"))
        self.btnBatOff.setText(_translate("MainWindow", "BAT OFF"))
        self.btnACCOn.setText(_translate("MainWindow", "ACC ON"))
        self.btnIGNOff.setText(_translate("MainWindow", "IGN OFF"))
        self.btnACCOff.setText(_translate("MainWindow", "ACC OFF"))
        self.btnIGNOn.setText(_translate("MainWindow", "IGN ON"))
